...
/*   Updated: 2023/05/02 21:26:06 by soulee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	box_x_compare(t_shape a, t_shape b, int axis)
{
	return (box_compare(a, b, 0));
}

int	box_y_compare(t_shape a, t_shape b, int axis)
{
	return (box_compare(a, b, 1));
}

int	box_z_compare(t_shape a, t_shape b, int axis)
{
